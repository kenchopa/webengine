...
class AuthWebUser extends CWebUser
{
    ...
    {
        return ($this->getUserModel()->Level == User::LEVEL_SUPERADMIN ? true : false);
    }
    
    public function isAdmin()
    {
        return ($this->getUserModel()->Level == User::LEVEL_ADMIN ? true : false);
    }
    
    public function isMember()
    {
        return ($this->getUserModel()->Level == User::LEVEL_MEMBER ? true : false);
    }
